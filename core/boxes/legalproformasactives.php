 ...
 */
class legalproformasactives extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "legalcongbox7";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		$this->boxlabel = $langs->transnoentitiesnoconv("Top10ProformasActives");
	...
	public function loadBox($max = 5)
	{
        ...
        $this->info_box_head = array('text' => $langs->trans("Top10ProformasActives"));
