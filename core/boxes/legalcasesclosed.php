 ...
 */
class legalcasesclosed extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "legalcongbox8";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		$this->boxlabel = $langs->transnoentitiesnoconv("Top10CasesClosed");
	...
	public function loadBox($max = 5)
	{
        ...
        $this->info_box_head = array('text' => $langs->trans("Top10CasesClosed"));
