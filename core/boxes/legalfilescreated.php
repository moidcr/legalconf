 ...
 */
class legalfilescreated extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "legalcongbox3";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		$this->boxlabel = $langs->transnoentitiesnoconv("Top10CreatedFiles");
	...
	public function loadBox($max = 5)
	{
        ...
        $this->info_box_head = array('text' => $langs->trans("Top10CreatedFiles"));
		...
		if ($user->rights->birthdaysoc->myobject->read || 1==1)
		{
			...
			$sql .= " WHERE `soc`.`soc_status` = 'Activa'";
