 ...
 */
class legalfilesinactives extends ModeleBoxes
{
	/**
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		$this->boxlabel = $langs->transnoentitiesnoconv("Top10InactivedFiles");
	...
	public function loadBox($max = 5)
	{
        ...
        $this->info_box_head = array('text' => $langs->trans("Top10InactivedFiles"));
		...
		if ($user->rights->birthdaysoc->myobject->read || 1==1)
		{
			...
			$sql .= " ORDER BY `soc`.`modified_on` DESC";
